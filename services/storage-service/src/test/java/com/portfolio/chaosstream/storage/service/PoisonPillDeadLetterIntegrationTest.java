...
@EmbeddedKafka(partitions = 1, topics = {
        PoisonPillDeadLetterIntegrationTest.VALIDATED_TOPIC,
...
class PoisonPillDeadLetterIntegrationTest {
    ...
    static final String DLT_TOPIC = "transactions.validated.v1.DLT";
    ...
    void malformedMessage_getsDeadLettered() {
        rawKafkaTemplate.send(new ProducerRecord<>(VALIDATED_TOPIC, "poison-pill-key", "not-valid-json"));
